...
module.exports = class InternetComponent extends BaseComponent {
  ...
  build(parent) {
    return {
       ...
       *
       * @param {string} inFirstName first name to use
       * @param {string} inLastName last name to use
       * @param {string} inProvider mail provider domain to use
       */
       ...
       *
       * @param {number} version version of protocol (default: 4)
       */
      ip: (version = 4) =>
        version === 4
       ...
       *
       * @param {mixed} inOpts user agent options {browser, os, device}
       */
      userAgent: (inOpts = {}) => {
       ...
       *
       * @param {string} inType type of mime (default: random)
       */
      mimeType: (inType) => {
        const mimes = inType
